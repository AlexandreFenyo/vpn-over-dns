...
// les pbs de licence rencontres sur Marshmallow: https://code.google.com/p/android/issues/detail?id=78505
...
public class AndroidLicensing implements FREFunction  {
	...
	public FREObject call(FREContext ctx, FREObject[] passedArgs) {
	    ...
	    // Log.i("vpnoverdns", "AndroidLicensing.call()");
		...
		try{
		    ...
		    Log.i("vpnoverdns", "exception non catchee dans checkLicense:" + e.toString());
		}
	...
	private static final byte[] SALT = new byte[] {
		// Alex: pas utilisé (cf. plus loin)
	    53, 23, 21, 112, -103, -57, 74, -64, 51, 88, -95,
