...
public class LicenseChecker implements ServiceConnection {
    private static final String TAG = "LicenseChecker-vpnoverdns";
	...
	// Log.i("vpnoverdns", "LicenseChecker(): packageName: " + mPackageName);
        // => packageName: air.com.mail4hotspot
	// Log.i("vpnoverdns", "LicenseChecker(): versionCode: " + mVersionCode);
        // => versionCode: 2000000
    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                ...
                try {
		    // Alex: j'applique https://code.google.com/p/android/issues/detail?id=78505#c8
		    ...
		    // au lieu du code d'exemple fourni par Google :
//                    boolean bindResult = mContext
//                            .bindService(
//                                    new Intent(
//                                            new String(
